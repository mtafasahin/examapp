...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NavbarComponent, EducationBannerComponent, FunfactsComponent,
    AboutComponent, CategoriesComponent, LandingCoursesComponent, PartnersComponent, 
    HowItWorksComponent, OverviewComponent, LandingFooterComponent,EduBlogComponent,AboutUsComponent,FaqComponent,
  PricingComponent],
